...
Dividir os dados para treinamento e teste, eno que 70% será para treinamento e 30% para teste

X_train e X_test: trinar, testar
y_train e y_test: trinar, testar

random_state=42: garantir a reprodutibiliade dos resultados
"""
...
print(f"\nA métrica da AUC/ROC (Área sob a curva ROC) é: {auc:.2f}, siginifica boa capacidade de distinguir as classes distintas")