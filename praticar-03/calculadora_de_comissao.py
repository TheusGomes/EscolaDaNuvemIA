...
# Lê os dados
nome = input("Digite seu nome: ")                       # nome do vendedor
salario_fixo = float(input("Digite seu sálario: "))       # salário fixo (double)
total_vendas = float(input("Digite seu total de vendas: "))       # total de vendas (double)

# Calcula comissão e total a receber
