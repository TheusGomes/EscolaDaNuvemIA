...
N1 = float(input("Digete a sua primeira (N1): "))
N2 = float(input("Digite a sua segunda nota(N2): "))
N3 = float(input("Digite a sua terceira nota(N3) "))
N4 = float(input("Digite a sua quarta nota(N4): "))
...
if media >= 7.0:
    ...
    exame = float(input("Digite nota do exame: "))
